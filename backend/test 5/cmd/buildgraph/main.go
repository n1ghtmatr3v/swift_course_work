...
func main() {
	...
	http.HandleFunc("/geocode", server.geocodeHandler)
	http.HandleFunc("/reverse-geocode", server.coordinatesToAddressHandler)
	http.HandleFunc("/route-by-address", server.routeByAddressHandler)
